...
export const columns: ColumnDef<FeedFormulation>[] = [
    {
        accessorKey: "formulaName",
        enableColumnFilter: true,
        header: ({column}) => <DataTableSortColumn title={'Formula Name'} column={column}/>,
        cell: ({row}) => <Link className={'text-blue-600 hover:underline'}
                               to={`/dashboard/feed-formulation/${row.original.id}/ingredients`}>{row.original.formulaName}</Link>
    },
    {
        id: "actions",
        cell: ({row}) => {
                ...
                <div className={'inline-flex items-center flex-wrap gap-3'}>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <Link to={`/dashboard/feed-formulation/${row.original.id}`}>
                                <DropdownMenuItem>
